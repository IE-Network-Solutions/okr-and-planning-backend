...
describe('ObjectiveService', () => {
  ...
  beforeEach(async () => {
    ...
    const moduleRef = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: AverageOkrRuleService,
          useValue: mock<AverageOkrRuleService>(),
        },
        {
        ...
        {
          provide: AverageOkrCalculation,
          useValue: mock<AverageOkrCalculation>(),
        },
        {
  ...
  it('should be defined', () => {
    expect(objectiveService).toBeDefined();
  });
});
