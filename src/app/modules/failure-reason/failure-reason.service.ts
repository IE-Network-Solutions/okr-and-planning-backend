...
export class FailureReasonService {
  ...
  async createFailureReason(createFailureReasonDto: CreateFailureReasonDto, tenantId: string): Promise<FailureReason> {
    ...
    return this.failureReasonRepo.save(failureReason);
      ...
      async deleteFailureReason(failureReasonId:string,tenantId:string): Promise<any> {
